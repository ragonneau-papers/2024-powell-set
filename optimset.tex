...
The spirit of our analysis is similar to that of~\cite{Dodangeh_Vicente_Zhang_2016}, where it is proved that a widely used direction set is indeed optimal for directional direct search methods
