...
\author{
    ...
    \thanksgap{1ex}%
    \thanks{\email{tom.ragonneau@polyu.edu.hk}; \orcid{0000-0003-2717-2876}.}
    \and
    Zaikun Zhang%
    \texorpdfstring{\thanksmark{1}}{}%
    \thanksgap{1ex}%
    \thanks{\email{zaikun.zhang@polyu.edu.hk}; \orcid{0000-0001-8934-8190}.}
}
\date{\today}
...
\paragraph*{Funding} This work was funded by the University Grants Committee of Hong Kong under
projects PF18-24698 (Hong Kong PhD Fellowship Scheme), PolyU 253012/17P, PolyU 153054/20P, PolyU
153066/21P, and PolyU 153086/23P. It was also supported by The Hong Kong Polytechnic University
under projects P0009767, P0038928, P0045598,
\modified{and the CAS-Croucher Funding Scheme for ``CAS AMSS-PolyU Joint Laboratory of Applied Mathematics: Nonlinear Optimization Theory, Algorithms and Applications''}.
