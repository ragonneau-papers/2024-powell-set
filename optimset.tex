...
It is challenging to design optimization methods that do not rely on classical or generalized derivative information of the problems they solve, namely \gls{dfo} methods.\todo{Add examples}

\section{Description of the initial interpolation set}

\todo[noline]{Adapted from~\cite{Powell_2006}}
