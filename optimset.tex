...
\newcommand*{\linkedin}[1]{\textcolor{LinkedInBlue}{\faIcon{linkedin}} \href{https://www.linkedin.com/in/#1/}{#1}}
...
\newcommand*{\twitter}[1]{\textcolor{TwitterBlue}{\faIcon{twitter}} \href{https://twitter.com/#1/}{@#1}}
...
\begin{abstract}
    ...
    This set is optimal in the sense that it minimizes the constant of well-poisedness in a ball centered at the starting point.
...
We show that this interpolation set is optimal in the sense that it minimizes the constant of well-poisedness in a ball centered at the starting point, which is detailed in Theorem~\ref{th:optimset}.
...
Finally, we point out that the default setting in Powell's methods renders an optimal interpolation set in terms of the well-poisedness in a ball centered at the starting point.
...
based on sufficient decrease. While proving nothing surprising, this kind of investigation deepens our understanding about certain algorithmic strategies that we often employ but rarely ask why.
...
%In particular, we showed that the interpolation set he proposed for \solvername{newuoa} is optimal in the sense that it minimizes its constant of well-poisedness in a ball centered at the starting point.
...
This set is proved to be optimal under the default setting recommended by Powell, because it minimizes the constant of well-poisedness in a ball centered at the starting point.
...
Both authors are grateful to Professor Chen for her support, encouragement, and guidance during the thesis.
