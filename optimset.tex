...
\begin{proof}
    ...
    For~$x \in \mathcal{B}_p(1)$, we have~$\norm{x}_q \le \norm{x}_p \le 1$, and this bound is attained at the first coordinate vector~$e_1 \in \mathcal{B}_p(1)$, so that~\eqref{eq:max-norm-pq} holds in this case.
...
\paragraph*{Funding} This work was funded by the University Grants Committee of Hong Kong under projects PF18-24698 (Hong Kong PhD Fellowship Scheme), PolyU 253012/17P, PolyU 153054/20P, and PolyU 153066/21P. It was also supported by The Hong Kong Polytechnic University under project P0009767.
