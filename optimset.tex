...
\begin{abstract}
    \fxnote*{Write down the abstract (200 words)}{To do.}
\end{abstract}
...
\begin{proof}
    ...
    \begin{equation*}
        \Lambda_p \ge \max_{t \in \R} \set{1 - \frac{1}{\Delta} (2n + 1 - m) t : (2n + 1 - m) \abs{t}^p \le \Delta^p} = 1 + (2n + 1 - m)^{\frac{p - 1}{p}}.
    \end{equation*}
...
\fxnote*{Write down the conclusion}{To do.}
